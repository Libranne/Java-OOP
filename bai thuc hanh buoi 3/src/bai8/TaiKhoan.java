...
public class TaiKhoan {
    ...
    public void Taikhoan(String sotaikhoan, String tentaikhoan, double sotien, float laisuat) {
    ...
    public void hientt() {
        System.out.println("Số tài khoan:" + sotaikhoan + "");
        System.out.println("tên tài khoan:" + tentaikhoan + "");
